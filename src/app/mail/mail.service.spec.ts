...
describe('MailService', () => {
  ...
  describe('findAll', () => {
    it('should retrun a mail list with success', async () => {
      // Arrange
      const mailEntityMockList = [
        { id: '1', dueDate: '2022-11-15T12:00:00Z' },
        { id: '2', dueDate: '2022-11-30T12:00:00Z' },
      ] as MailEntity[];
    ...
    it('should return a filtered mail list with dueDateLte', async () => {
      // Arrange
      const mailEntityMockList = [{ id: '1', dueDate: '2022-11-15T12:00:00Z' }] as MailEntity[];
      const params: Partial<FindAllMailDto> = { dueDateLte: '2022-11-20T12:00:00Z' };
      getMany.mockResolvedValueOnce(mailEntityMockList);
      // Act
